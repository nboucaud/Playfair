...
| [Atgenomix SeqsLab](/docs/configuration/databases#atgenomix-seqslab)              | `pip install seqslab-connector`                                                    | `seqslab+hive://token:{access_token}@{host}:443/{job_run_name}?http_path={job_run_id}`                                                                      |
